...
const meta: Meta<typeof BaseDialogModal> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '基础对话框模态组件，支持自定义标题、内容、关闭按钮等功能。基于 Headless UI 构建，提供灵活的配置选项。',
      },
    },
  },
  argTypes: {
  ...
  args: {
    ...
    children: (
      <div className="text-white space-y-4">
        ...
        <p className="text-gray-200">您可以在这里放置任何内容，比如表单、图片或其他组件。</p>
  ...
  args: {
    ...
    children: (
      <div className="text-white space-y-4">
        ...
        <p className="text-gray-200">除了右上角的关闭图标，还有一个外部的关闭按钮。</p>
  ...
  args: {
    title: (
      <div className="text-center mb-4">
        ...
        <p className="text-gray-300 text-sm">这是一个带有图标和副标题的自定义标题</p>
      </div>
    ),
    closeIcon: true,
    buttonProps: (
    ...
    children: (
      <div className="text-white space-y-4">
        <p className="text-gray-200">标题可以是任何 React 组件，不仅仅是文本。</p>
        ...
        <BaseDialogModal
          ...
          children={
            <div className="text-white space-y-4">
              ...
              <p className="text-gray-200">您可以通过外部按钮来打开和关闭对话框。</p>
              <div className="bg-gray-800 p-3 rounded text-sm">
                <p className="text-gray-300">使用方法：</p>
                <code className="text-green-400">
                  modalRef.current?.open() // 打开<br/>
        ...
        {Array.from({ length: 10 }, (_, i) => (
          <div key={i} className="bg-gray-800 p-3 rounded">
            ...
            <p className="text-gray-300 text-sm">
              这是第 {i + 1} 个段落的内容。Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
